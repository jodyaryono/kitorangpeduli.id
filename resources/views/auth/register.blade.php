...
@section('title', 'Daftar - KitorangPeduli.id')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-yellow-500">
            <div class="papua-gradient px-8 py-6">
                <h2 class="text-2xl font-bold text-yellow-400 text-center">Daftar Sebagai Responden</h2>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('register.store') }}" method="POST" enctype="multipart/form-data" id="registrationForm">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Wilayah cascade selects - Updated: 2025-12-14 16:30
...
// Script version: 2025-12-15-0130
</script>
